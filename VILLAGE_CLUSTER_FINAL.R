...
#Converting all 0's ,in Total Population & for age group 0-6, to 1's...otherwise the next computation steps will evaluate to infinity
# summary(RVill$Population.in.the.age.group.0.6.Person)
# RVill$Population.in.the.age.group.0.6.Person <- ifelse(RVill$Population.in.the.age.group.0.6.Person==0, 1, RVill$Population.in.the.age.group.0.6.Person)
# summary(RVill$Population.in.the.age.group.0.6.Person)
# 
# summary(RVill$Total.Population.Person)
# RVill$Total.Population.Person <- ifelse(RVill$Total.Population.Person==0, 1, RVill$Total.Population.Person)
# summary(RVill$Total.Population.Person)
